...
function ProductItems({val}) {
  ...
  return (
    ...
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-base font-semibold tracking-tight ">{val?.title}</h5>
        </a>
        <div className="flex items-center mt-2.5">
            ...
            <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800 ml-3">5.0</span>
        </div>
